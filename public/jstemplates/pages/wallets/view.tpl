...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-4 pull-right">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<button type="button" id="add_profit_button" class="btn btn-success btn-block">{tp}Money In{/tp}</button>
	...
	<div class="col-xs-12 col-sm-12 col-md-8 pull-left">
		...
		<div class="list-group">
			<div class="list-group-item ">
				<h3 class="panel-title">{tp}Money Out{/tp}
				...
				<div class="form-group">
					<form method="post" id="add_transaction_form">
						<input type="text" class="form-control" id="add_transaction_text" placeholder="{t}Name Of Person / Transaction{/t}" data-i18nplaceholder="Name Of Person / Transaction">
	...
	<div class="col-xs-12 col-sm-12 col-md-4 pull-right">
		...
		<div class="panel panel-default" id="balance_canvas_container">
			<div class="panel-heading">
				<h3 class="panel-title">{tp}Money Out Per Day Trends{/tp}</h3>
			</div>
			<div class="panel-body">
